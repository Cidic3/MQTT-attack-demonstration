...
5. The following commands have been used for my attacks:
	-Unencrypted Communication: Navigate to the "unencrypted communication" Folder. Start the Docker Containers via "sudo docker compose up". A docker container has been setup to automatically connect and publish information every 20 	seconds after start up. Simply track packages in Wireshark.
